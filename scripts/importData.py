...
from common import (  # noqa: E402
    CFG, DATA_DIR, HUMAN_PARQUET, PERSONA_PARQUET, QUESTIONS_PARQUET,
    categorize, ensure_dirs, is_skipped_block, is_skipped_qid,
)
...
def main():
    ...
    for index in range(n):
        ...
        # --- human responses + question metadata (wave 4 questions) ---
        for element in json.loads(row["wave4_Q_wave1_3_A"]):
            ...
            for q in element.get("Questions", []):
                ...
                for rec in parse_question(q, block):
                    ...
                    human_rows.append({
                        ...
                        "answer": rec["answer"], "answertext": str(rec["answertext"]),
                        "normalized": norm,
                    })
